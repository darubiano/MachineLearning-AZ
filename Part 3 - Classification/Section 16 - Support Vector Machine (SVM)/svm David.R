...
# Ajustar el modelo k vecinos mas cercanos con el conjunto de entrenamiento
# y hacer predicciones con el conjunto de testing
#install.packages("e1071")
#library(e1071)
# Purchased variable dependiente ~ . punto paralas demas variables indepentiendes
